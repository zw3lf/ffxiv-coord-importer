...
namespace CoordImporter.Tests
{
    ...
    public class ParserTests
    {
        ...
        private static readonly string TestTurtleInputLine = $@"Sugriva @ {LinkChar}Thavnair ( 18.65 , 11.55 ) ";
        ...
        private static readonly string TestTurtleInstancedInputLine = $@"The raintriller @ {LinkChar}Kozama'uka{I2Char} ( 20.30 , 28.40 ) Instance TWO";
        ...
        private static readonly MarkData TestTurtleMarkData =
            new MarkData("Sugriva", "Thavnair", 3165, 943, null, new Vector2(18.65f, 11.55f));
        ...
        private static readonly MarkData TestTurtleInstancedMarkData =
            new MarkData("raintriller", "Kozama'uka", 7162, 603, 2, new Vector2(20.30f, 28.40f));
