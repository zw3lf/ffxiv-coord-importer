...
public class ParserTests
{
    ...
    private static readonly string TestSirenInputLine =
    ...
    private static readonly string TestSirenInstancedInputLine =
        $@"(Yilan) {LinkChar}Thavnair{I2Char} ( 26.8  , 20.9 )  (Instance TWO) ";
    private static readonly string TestFaloopInstancedInputLine =
    ...
    private static readonly MarkData TestSirenMarkData =
        new("Stolas", "The Dravanian Hinterlands", 362, 712, null, new Vector2(26.85f, 20.05f));
    private static readonly MarkData TestFaloopMarkData =
        new("Gamma", "Yanxia", 14, 1343, null, new Vector2(23.6f, 11.4f));
    private static readonly MarkData TestBearMarkData =
        new("Supay", "The Rak'tika Greatwood", 3067, 32, null, new Vector2(14.6f, 22.3f));
    private static readonly MarkData TestSirenInstancedMarkData =
        new("Yilan", "Thavnair", 5362, 15, 2, new Vector2(26.8f, 20.9f));
    private static readonly MarkData TestFaloopInstancedMarkData =
        new("Vogaal Ja", "Middle La Noscea", 83, 433, 1, new Vector2(8.2f, 32.65f));
    private static readonly MarkData TestBearInstancedMarkData =
        new("Sugriva", "Thavnair", 316, 2283, 3, new Vector2(27.6f, 25.6f));
